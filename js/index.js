...
document.addEventListener("scroll", () => {
    if (window.scrollY >= 0) {
        link11.style.background = "white";
        link11.style.color = "black";
        link12.style.background = "rgb(112, 29, 29)";
        link12.style.color = "white";
        link13.style.background = "rgb(112, 29, 29)";
        link13.style.color = "white";
        link14.style.background = "rgb(112, 29, 29)";
        link14.style.color = "white";
        link15.style.background = "rgb(112, 29, 29)";
        link15.style.color = "white";
    }
});
